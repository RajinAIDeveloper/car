...
// Using a generic SVG for WhatsApp icon to avoid adding a new library just for one icon
// In a real project, consider `react-icons/fa` or similar if more icons are needed.
const WhatsAppIcon = () => (
